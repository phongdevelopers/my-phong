<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" CodeFile="DeleteVendor.aspx.cs" Inherits="Admin_People_Vendors_DeleteVendor" Title="Delete Vendor"  %>
        ...
        <tr>
            <td valign="top" width="300">
                <ajax:UpdatePanel ID="EditAjax" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Label ID="InstructionText" runat="server" Text="This vendor has one or more associated products.  Indicate what vendor these products should be changed to when {0} is deleted." EnableViewState="false"></asp:Label>
