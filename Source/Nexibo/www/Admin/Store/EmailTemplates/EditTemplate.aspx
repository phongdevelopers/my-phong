<%@ Page Language="C#" MasterPageFile="../../Admin.master" AutoEventWireup="true" CodeFile="EditTemplate.aspx.cs" Inherits="Admin_Store_EmailTemplates_EditTemplate" Title="Edit Email Template" %>
        ...
        <tr>
            <td valign="top">
                <div class="pageContent">
                    <asp:Label ID="SavedMessage" runat="server" Text="Email template updated at {0:t}" SkinID="GoodCondition" Visible="false" EnableViewState="false"></asp:Label>
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
							        ...
							        <asp:Button ID="EventTriggersCancelButton" runat="server" Text="Cancel" CausesValidation="false" OnClick="CancelButton_Click" />
                                </td>
                            </tr>
                        </table>   
                    </ComponentArt:PageView>
