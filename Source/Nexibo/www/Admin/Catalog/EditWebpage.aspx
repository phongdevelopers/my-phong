<%@ Page Language="C#" MasterPageFile="~/Admin/Catalog/Webpage-Link.master" AutoEventWireup="true" CodeFile="EditWebpage.aspx.cs" Inherits="Admin_Catalog_EditWebpage" Title="Edit Webpage" %>
    ...
    <table cellpadding="2" cellspacing="0" class="innerLayout">
	    <tr>
	        <td class="validation">
				...
				<asp:Label ID="SavedMessage" runat="server" Text="Webpage saved at {0:t}" SkinID="GoodCondition" EnableViewState="False" Visible="false"></asp:Label>
	        </td>
	    </tr>
	    <tr>
	        <td>
                <table class="inputForm">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <asp:TextBox ID="Summary" runat="server" Text="" TextMode="multiLine" Height="100px" MaxLength="1000" Columns="120"></asp:TextBox><br />
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <asp:TextBox ID="WebpageContent" runat="server" Columns="120" Height="200px" TextMode="multiLine"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
