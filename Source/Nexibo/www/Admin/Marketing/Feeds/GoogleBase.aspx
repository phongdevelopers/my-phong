<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="GoogleBase.aspx.cs" Inherits="Admin_Marketing_Feeds_GoogleBase" Title="GoogleBase Feed" %>
                ...
                <tr>
                    <td colspan="2" align="center">
                        <p class="InstructionText">
                            Specify GoogleBase Feed Configuration Options Below.</p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <table class="inputForm">
                            ...
                            <tr>
                                <th class="rowHeader" width="50%">
                                    ...
                                    <br />
                                    <span class="helpText">Name of the file to set on remote server</span>
                                </th>
                                <td valign="Top" width="50%">
