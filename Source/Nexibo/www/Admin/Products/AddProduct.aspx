<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="AddProduct.aspx.cs" Inherits="Admin_Products_AddProduct" Title="Add Product" %>
...
<table cellpadding="2" cellspacing="0" class="innerLayout">
    <tr>
        <td class="menuPanel" valign="top">
            <div class="section">
                <div class="header">
                    <h2><asp:Localize id="SidebarCaption" runat="server" Text="Add Product"></asp:Localize></h2>
                </div>                
                <div class="content">                    
                    <asp:Label ID="AddProductHelpMessage" runat="server" Text="Once the product is added, you will be able to access additional settings."></asp:Label><br /><br />                    
                </div>
            </div>
        </td>
        <td class="innerLayoutContent" valign="top">
            ...
            <table cellpadding="3" cellspacing="0" class="inputForm" width="100%">
                <tr>
                    <td class="submit" colspan="4" >
						...
						<asp:Button ID="SaveAndCloseButton1" runat="server" Text="Save And Close" OnClick="SaveAndCloseButton_Click"></asp:Button>
            ...
            <cb:ToolTipLabel ID="SummaryLabel" runat="server" Text="Summary:" ToolTip="A brief description of the product that can be used for the category listings or featured products."></cb:ToolTipLabel>
                    ...
                    <td colspan="3" style="padding-right:6px;">
                        <asp:TextBox ID="Summary" runat="Server" Text="" Rows="5" TextMode="MultiLine" Width="100%" MaxLength="1000" /><asp:CustomValidator ID="SummaryValidator" runat="server" ControlToValidate="Summary" Text="*"></asp:CustomValidator>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <asp:TextBox ID="Description" runat="server" Width="100%" Height="200px" TextMode="multiLine" />
                    </td>
                </tr>
                <tr>
                    <th class="rowHeader" style="vertical-align:top;">
                    ...
                    <td colspan="3">
                        <asp:TextBox ID="ExtendedDescription" runat="server" Width="100%" Height="200px" TextMode="multiLine" />
                    </td>
                </tr>
                <tr>
                    <th class="rowHeader" valign="top" nowrap>
        ...
        <td colspan="3">
            <asp:TextBox ID="SearchKeywords" runat="server" Text="" TextMode="multiLine" Rows="5" Width="100%"></asp:TextBox><br />
        </td>
    </tr>
                <tr>
                ...
                <tr>
                    <td class="submit" colspan="4">                        
						...
						<asp:Button ID="SaveAndCloseButton" runat="server" Text="Save And Close" OnClick="SaveAndCloseButton_Click"></asp:Button>
