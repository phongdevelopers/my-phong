<%@ Page Language="C#" MasterPageFile="../Product.master" CodeFile="EditSpecial.aspx.cs" Inherits="Admin_Products_Specials_EditSpecial" Title="Edit Pricing Rule"  %>
<%@ Register Src="~/Admin/UserControls/PickerAndCalendar.ascx" TagName="PickerAndCalendar" TagPrefix="uc" %>

<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    <div class="pageHeader">
        <div class="caption">
            <h1><asp:Localize ID="Caption" runat="server" Text="Editing Price Rule for {0}"></asp:Localize></h1>
        </div>
    </div>        
    <p align="justify">
        <asp:Label ID="SavedMessage" runat="server" Text="Saved at {0:t}<br />" Visible="false" EnableViewState="false" SkinID="GoodCondition"></asp:Label>
        <asp:Localize ID="InstructionText" runat="server" Text="Only price is required.  You can optionally restrict the price by date or group."></asp:Localize>
    </p>    
