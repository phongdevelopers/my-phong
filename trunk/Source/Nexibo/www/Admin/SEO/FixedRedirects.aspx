<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="FixedRedirects.aspx.cs" Inherits="Admin_SEO_FixedRedirects" Title="Fixed Redirects" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="bodyText">
        Use this screen to view and manage fixed redirects for your store.  Fixed redirects are those where the request path and and the redirect URL are specific resources.  One and only one page is directly replaced by another.  If you need to configure redirects that cover many pages or even whole directories using pattern matching (regular expressions), you need to use <a href="dynamicredirects.aspx">dynamic redirects</a> instead.  
        <asp:Localize ID="IISVersionWarningText" runat="server" Text="NOTE: IIS6 or below is detected.  The request path must be an aspx page unless you have modified the IIS configuration." EnableViewState="false" Visible="true"></asp:Localize>
    </div>
