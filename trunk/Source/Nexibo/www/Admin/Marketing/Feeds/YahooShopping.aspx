<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="YahooShopping.aspx.cs" Inherits="Admin_Marketing_Feeds_YahooShopping" Title="Yahoo Shopping Feed" %>
            ...
            <tr>
                <td colspan="2" align="center">
                    <p class="InstructionText">
                        Specify Yahoo Shopping Feed Configuration Options Below.</p>
                </td>
            </tr>
            <tr>
                <td>
                    <table class="inputForm">
                        ...
                        <tr>
                            <th class="rowHeader" width="50%">
                                ...
                                <br />
                                <span class="helpText">Should the existing feed file be overwritten when creating new
                                    feed?</span>
                            </th>
                            <td valign="Top" width="50%">
                                <asp:RadioButtonList ID="AllowOverwrite" runat="server" RepeatDirection="Vertical">
                        ...
                        <tr>
                            <th class="rowHeader" width="50%">
                                ...
                                <br />
                                <span class="helpText">Which Products to Include in the feed?</span>
                            </th>
                            <td valign="Top" width="50%">
                        ...
                        <tr>
                            <th class="rowHeader" width="50%">
                                ...
                                <br />
                                <span class="helpText">Should the existing compressed feed file be overwritten when
                                    creating new compressed feed?</span>
                            </th>
                            <td valign="Top" width="50%">
                                <asp:RadioButtonList ID="AllowOverwriteCompressed" runat="server" RepeatDirection="Vertical">
                                    <asp:ListItem Text="No" Value="0"></asp:ListItem>
                                    <asp:ListItem Text="Yes" Value="1"></asp:ListItem>
                                </asp:RadioButtonList>
                            </td>
                        ...
                        <tr>
                            <th class="rowHeader" width="50%">
                                ...
                                <br />
                                <span class="helpText">Enter the directory and file name to set on the remote server
                                    (e.g. 1234567/data.txt)</span>
                            </th>
                            <td valign="Top" width="50%">
