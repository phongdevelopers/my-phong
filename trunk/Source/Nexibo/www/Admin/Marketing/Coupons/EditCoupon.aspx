<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="EditCoupon.aspx.cs" Inherits="Admin_Marketing_Coupons_EditCoupon" Title="Edit Coupon" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <div class="pageHeader">
		<div class="caption">
			<h1><asp:Localize ID="Caption" runat="server" Text="Edit Coupon '{0}'"></asp:Localize></h1>
		</div>
    </div>
    <table cellpadding="2" cellspacing="0" class="innerLayout">
        <tr>
            <td>
                <asp:Label ID="SavedMessage" runat="server" Text="Saved at {0:t}" Visible="false" EnableViewState="false" SkinID="GoodCondition"></asp:Label>
                        ...
                        <td colspan="3">
                            <ajax:UpdatePanel ID="ProductRuleAjax" runat="server" UpdateMode="conditional">
                                <ContentTemplate>
                                    ...
                                    <asp:Panel ID="ProductRulePanel" runat="server" Visible="false">
                                        <br />
                                        <asp:Label ID="ProductCount" runat="server" Text="{0} Products Selected"></asp:Label>
                                        <asp:LinkButton ID="ManageCouponProducts" runat="server" Text="manage" OnClick="ManageCouponProducts_Click" SkinID="Link" CausesValidation="true"></asp:LinkButton>
                                    </asp:Panel>
                                </ContentTemplate>
                            </ajax:UpdatePanel>
                        </td>
        ...
        <tr>
            <td class="submit">                
				...
				<asp:Button ID="BackButton" runat="server" Text="Close" OnClick="BackButton_Click" CausesValidation="false" />
            </td>
        </tr>
    </table>
</asp:Content>
