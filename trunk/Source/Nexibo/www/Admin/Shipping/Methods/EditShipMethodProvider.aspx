<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" CodeFile="EditShipMethodProvider.aspx.cs" Inherits="Admin_Shipping_Methods_EditShipMethodProvider" Title="Edit Shipping Method"  %>
                ...
                <table class="inputForm" cellpadding="4" width="700px">
                    <tr>
                        ...
                        <th class="rowHeader" width="200px">
                            <asp:Label ID="ShipMethodTypeLabel" runat="server" Text="Provider:"></asp:Label>
                        </th>
                        <td width="200px">
                    ...
                    <tr>
                        <th class="rowHeader">
                            <cb:ToolTipLabel ID="ServiceCodeLabel" runat="server" Text="Service:" ToolTip="The service available from the integrated provider that is used to calculate the cost for this shipping method." />
                        </th>
                        <td colspan="3">
                            <asp:DropDownList ID="ServiceCode" runat="server"></asp:DropDownList>
