<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" CodeFile="DeleteWarehouse.aspx.cs" Inherits="Admin_Shipping_Warehouses_DeleteWarehouse" Title="Delete Warehouse"  %>
        ...
        <tr>
            <td valign="top" width="300">
                <ajax:UpdatePanel ID="EditAjax" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Label ID="InstructionText" runat="server" Text="This warehouse has one or more associated products.  Indicate what warehouse these products should be changed to when {0} is deleted." EnableViewState="false"></asp:Label>
